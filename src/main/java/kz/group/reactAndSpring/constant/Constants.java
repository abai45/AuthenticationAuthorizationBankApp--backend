...
public class Constants {
    ...
    public static final String[] PUBLIC_URLS = { "/user/resendotp","/user/images/**", "/user/mfa/set", "/user/delete" ,"/user/resetpassword/reset/**", "/user/verify/resetpassword/**", "/user/resetpassword/**", "/user/verify/**", "/user/login/**", "/user/verify/account/**", "/user/register/**", "/user/new/password/**", "/user/verify/**", "/user/resetpassword/**", "/user/image/**", "/user/verify/password/**" };
