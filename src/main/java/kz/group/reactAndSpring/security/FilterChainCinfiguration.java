...
//
//import kz.group.reactAndSpring.handler.ApiAuthenticationEntityPoint;
...
//    private final ApiAuthenticationEntityPoint apiAuthenticationEntityPoint;
//
//    @Bean
//    public SecurityFilterChain securityFilterChain(HttpSecurity http, ApiHttpConfigurer apiHttpConfigurer) throws Exception {
//        http
...
//                                .authenticationEntryPoint(apiAuthenticationEntityPoint))
//                .authorizeHttpRequests(request ->
//                        request.requestMatchers(PUBLIC_URLS).permitAll()
//                                .requestMatchers(OPTIONS).permitAll()
//                                .requestMatchers(DELETE, "/user/delete/**")
//                                .hasAnyAuthority("user:delete")
//                                .requestMatchers(DELETE, "/transfer/delete/**")
//                                .hasAnyAuthority("transfer:delete")
        ...
        http
                ...
                .authorizeHttpRequests(request ->
                        request.requestMatchers(PUBLIC_URLS).permitAll()
                                ...
                                .requestMatchers(DELETE, "/transfer/delete/**").hasAnyAuthority("transfer:delete")
                                .anyRequest().authenticated())
                .with(apiHttpConfigurer, withDefaults());
        return http.build();
    }
