...
CREATE TABLE IF NOT EXISTS users (
                                     ...
                                     img_url CHARACTER VARYING(255) DEFAULT 'https://cdn-icons-png.flaticon.com/512/149/149071.png',
...
CREATE TABLE IF NOT EXISTS user_roles (
                                          ...
                                          CONSTRAINT fk_user_roles_role_id FOREIGN KEY (user_id) REFERENCES roles (id) MATCH SIMPLE ON UPDATE CASCADE ON DELETE RESTRICT
);
